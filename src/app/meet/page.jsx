    ...
    <main className="flex justify-center items-center min-h-screen bg-gray-100 overflow-hidden">
      <div className="relative w-full max-w-[425px] min-h-screen bg-gradient-to-b from-[#DEEEE2] via-[#FFFFFF] to-[#F6EFE8] shadow-lg sm:rounded-none flex flex-col justify-between">
        ...
        <div className="relative z-10 mt-4 sm:mt-6">
          <Link href="/chat">
            <div className="px-2 py-2 flex justify-center items-center w-full max-w-22 mx-auto text-sm sm:text-xs font-semibold text-white rounded-full bg-gradient-to-r from-pink-300 to-orange-300 shadow-md cursor-pointer hover:scale-105 transition">
              {b("chat")}
            </div>
          </Link>
        </div>

        <div className="relative z-10 flex flex-col items-center justify-center text-justify text-[#4A4365] px-6 sm:px-8 flex-grow space-y-2 py-1 sm:py-2">
          <p className="text-xl sm:text-2xl font-semibold">{t("heading")}</p>
          <p className="text-sm sm:text-base leading-relaxed">{t("text")}</p>

          {/* Image */}
          <div className="relative w-full my-2 max-w-[360px] h-[250px] sm:h-[260px] rounded-2xl overflow-hidden">
            <Image
              src="/meet.webp"
              alt="Vinita Meet"
              fill
        ...
        <div className="relative z-10 flex justify-center items-center gap-3 pb-24 sm:pb-22">
          ...
          <Link href="https://meet.vinitarashinkar.in/" target="_blank">
